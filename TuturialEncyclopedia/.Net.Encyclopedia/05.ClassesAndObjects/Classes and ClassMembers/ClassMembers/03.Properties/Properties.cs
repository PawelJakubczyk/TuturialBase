...
public class Properties
{
    ...
    {
        PersonForPropertiesExamples person = new("Mark") { Id = 1, IsHardWorking = true };
        person.Salary = 100;
        Console.WriteLine($"Mark salary is {person.Salary}");

        PersonForPropertiesExamples person1 = new("Tom") { Id = 2, IsManagerSon = true };
        person.Salary = 100;
...
public class PersonForPropertiesExamples
{
    ...
    public PersonForPropertiesExamples(string name)
    {
        Name = name;
    }
}
